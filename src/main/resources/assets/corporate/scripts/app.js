...
var App = function() {
  ...
  var purchase_in_state_data = [{id:0, text:'未对账'}, {id:1, text:'对账中'}, {id:2, text:'已开票'}, {id:3, text:'已删除'}];
  var purchase_in_u8_state_data = [{id:0, text:'新建'}, {id:1, text:'审核'}, {id:2, text:'已删除'}];
  ...
  return {
    ...
    getPurchaseInU8StateOfId: function(id) {
      return getLabelOfId(purchase_in_u8_state_data, id);
    },
