...
var App = function() {
  ...
  var invoice_state_data = [{id:0, text:"未开发票"}, {id:1, text:"已开发票"}, {id:2, text:"发票已退回"}, {id:3, text:"发票已审核"}, {id:4, text:"已传递ERP"}];
  var statement_state_data = [{id:1, text:"新建"}, {id:2, text:"提交"}, {id:3, text:"审核"}, {id:4, text:"发布"}, {id:5, text:"撤回"}, {id:6, text:"确认"}, {id:7, text:"退回"}];
