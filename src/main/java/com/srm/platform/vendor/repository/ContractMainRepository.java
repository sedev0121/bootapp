...
public interface ContractMainRepository extends JpaRepository<ContractMain, Long> {
	...
	Page<ContractSearchItem> findAllOfPurchaseOrder(String orderCode, String search, Pageable pageable);
}
