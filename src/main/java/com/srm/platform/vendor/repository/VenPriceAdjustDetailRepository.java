...
public interface VenPriceAdjustDetailRepository extends JpaRepository<VenPriceAdjustDetail, Long> {
	...
	@Query(value = "select b.name, b.specs, b.main_measure puunit_name, a.* from venpriceadjust_detail a left join inventory b on a.cinvcode=b.code where  a.mainid= :mainId order by a.rowno", nativeQuery = true)
