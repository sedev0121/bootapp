...
public interface StatementDetailRepository extends JpaRepository<StatementDetail, Long> {
	...
	@Query(value = "select a.*, c.code pi_code, c.auto_id pi_auto_id, c.tax_rate pi_tax_rate, c.tax_price pi_tax_price, d.vendor_code pi_vendor_code, d.store_code pi_store_code, d.date pi_date, e.code inventory_code, e.name inventory_name, e.specs, e.main_measure unitname, "
