...
public interface StatementDetailRepository extends JpaRepository<StatementDetail, Long> {
	...
	@Query(value = "select a.*, d.code pi_code, c.auto_id pi_auto_id, c.state pi_state, c.erp_changed pi_erp_changed, c.tax_rate pi_tax_rate, c.tax_price pi_tax_price, d.vendor_code pi_vendor_code, d.store_code pi_store_code, d.date pi_date, e.code inventory_code, e.name inventory_name, e.specs, e.main_measure unitname, "
			+ "c.quantity pi_quantity, c.price, c.cost, c.tax_price, c.tax_cost, pom.code po_code, po.row_no po_row_no, po.confirmed_memo confirmed_memo, "
