...
public interface StatementDetailRepository extends JpaRepository<StatementDetail, Long> {
	...
	@Query(value = "select a.*, c.quantity-ifnull(a.closed_quantity, 0) remain_quantity, d.type, c.code purchase_in_code, c.rowno, c.quantity, c.price, c.cost, c.tax_price, c.tax_cost, c.nat_tax_price, c.material_quantity, c.material_tax_price, "
