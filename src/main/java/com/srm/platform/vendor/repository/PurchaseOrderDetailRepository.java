...
public interface PurchaseOrderDetailRepository extends JpaRepository<PurchaseOrderDetail, Long> {
	...
	@Query(value = "select * from purchase_order_detail a left join purchase_order_main b on a.close_date is null and a.code=b.code where b.srmstate=2 and a.quantity>a.arrived_quantity and (a.inventory_code like %?1% or a.inventory_name like %?1%) and b.vencode=?2 and b.company_id=?3 and b.store_id=?4", nativeQuery = true)
