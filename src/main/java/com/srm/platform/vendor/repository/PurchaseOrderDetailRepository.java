...
public interface PurchaseOrderDetailRepository extends JpaRepository<PurchaseOrderDetail, Long> {
	...
	@Query(value = "select * from purchase_order_detail a left join purchase_order_main b on a.close_date is null and a.main_id=b.id where b.srmstate=2 and a.quantity>ifnull(a.delivered_quantity, 0) and (a.inventory_code like %?1% or a.inventory_name like %?1%) and b.vencode=?2 and b.company_id=?3 and b.store_id=?4 and b.purchase_type_name=?5", nativeQuery = true)
